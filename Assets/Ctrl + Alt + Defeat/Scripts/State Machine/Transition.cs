...
namespace CAD
{
    ...
    public class Transition
    {
        ...
        /// </summary>
        /// <value>
        /// A <see cref="Func{SmartTank, bool}"/> representing the condition. It takes a <see cref="SmartTank"/> 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Transition"/> class with the specified name and condition.
        /// </summary>
        /// <param name="name">
        /// The name of this transition. Used by the node editor to create and name an output port.
        /// </param>
        ...
        /// It takes a <see cref="SmartTank"/> as input and returns a <see cref="bool"/> indicating whether the transition condition is met.
        /// </param>
